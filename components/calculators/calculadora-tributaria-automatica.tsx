...
export function CalculadoraTributariaAutomatica() {
  ...
  const gerarPDF = () => {
    ...
    doc.text("Gerado por CTributaria - Jornal Tributario", pageWidth / 2, y, { align: "center" })
    ...
    <Card className="border-gray-200 dark:border-gray-700 lg:col-span-2">
      <CardHeader>
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-r from-[#FF7A00] to-[#FF9500] rounded-lg">
        ...
        {produtoSelecionado && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-end">
              <Button 
                onClick={calcular}
                className="w-full bg-gradient-to-r from-[#FF7A00] to-[#FF9500] hover:from-[#FF9500] hover:to-[#FFB000]"
              >
