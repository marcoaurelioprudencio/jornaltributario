  ...
  return (
    <Card className="border-gray-200 dark:border-gray-700">
      ...
      <CardContent className="space-y-4">
        ...
        <Button onClick={calcular} className="w-full bg-[#FF7A00] hover:bg-[#FF9500]">
          ...
          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-3">
            ...
            <div className="border-t pt-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-lg text-[#FF7A00]">{formatCurrency(resultado.difalValor)}</span>
              </div>
            </div>
