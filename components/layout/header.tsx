...
import { Menu, Moon, Sun, Search, X, Home, Wrench, Newspaper, BookOpen, MessageCircle } from "lucide-react"
    ...
    <>
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              ...
              <Link
                href="/contato"
                className="bg-gradient-to-r from-[#FF7A00] to-[#FF9500] text-white px-4 py-2 rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-orange-500/30 transition-all duration-300"
              >
                Fale Conosco
              </Link>
            </nav>
            ...
            <div className="flex items-center gap-3">
              <div className="hidden xl:flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-full px-4 py-2 transition-all hover:bg-gray-200 dark:hover:bg-gray-700">
                <Search className="h-4 w-4 text-gray-500 dark:text-gray-400" />
                <Input
                  placeholder="Pesquisar..."
                  className="border-0 bg-transparent text-sm w-[160px] focus-visible:ring-0 p-0 h-auto dark:text-gray-200"
                />
              </div>

              <Select defaultValue="MG">
                <SelectTrigger className="w-[80px] border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors dark:text-gray-200 text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <Button
                ...
                className="lg:hidden text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"
              >
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-[300px] bg-white dark:bg-gray-900 shadow-2xl z-50 lg:hidden animate-slide-in-right">
            <div className="p-6">
              ...
              <nav className="space-y-2">
                ...
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
                >
                  <Newspaper className="h-5 w-5 text-[#FF7A00]" />
                ...
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
                >
                  <Wrench className="h-5 w-5 text-[#FF7A00]" />
